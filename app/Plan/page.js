    ...
    <>
      ...
      <div className="min-h-screen bg-neutral-100 dark:bg-neutral-900 py-8 px-6">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          {/* FREE PLAN */}
          <div className="p-8 border rounded-2xl bg-white dark:bg-neutral-800 shadow-sm">
           ...
           <button className="w-full mt-55 bg-gray-800 dark:bg-gray-700 text-white py-3 rounded-xl font-semibold bottom-0">
              Get Started
            </button>
          </div>
          ...
          <div className="p-8 border-2 border-yellow-400 rounded-2xl bg-yellow-50 dark:bg-neutral-800 shadow-md relative">
            ...
            <button className="w-full mt-8 bg-yellow-500 text-black py-3 rounded-xl font-semibold hover:bg-yellow-400 transition">
              Upgrade Now
            </button>
          </div>
